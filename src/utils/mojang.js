...
class Mojang {
    ...
    static generateMOTD(text, spacing, padding) {
        ...
        lines.forEach((raw, index) => {
                ...
                if (build.extras.obfuscated) {
                    ...
                    for (let i = 0; i < length; i++) {
                        ...
                        while (!char || banned.includes(char)) {
                            char = String.fromCharCode(start + Math.floor(Math.random() * (end - start)))
                        }
                        build.text += char
                    }
                };
                            ...
                            if (build.fillStyle != colors.f || build.changed) {
                                ...
                                build = {
                                    ...
                                    extras: {
                                        ...
                                        strikethrough: build.extras.strikethrough
                                    },
                                    changed: false
                                }
            ...
            Util.fillMixedText(context, buildList, tempPadding, tempPadding + 20 * index + spacing * index, motd.width)
        })
